...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAddemployeeAddemployeeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _emprecord_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../emprecord.service */
    ...
    /*#__PURE__*/
    function () {
      function AddemployeeComponent(router, emprecordService) {
      ...
      _createClass(AddemployeeComponent, [{
        ...
        value: function InsertEmployee(employee) {
          ...
          this.emprecordService.InsertEmployee(employee).subscribe(function () {
            if (_this.EmployeeIdUpdate == "0") {
              _this.massage = 'Saved Successfully';
            } else {
              _this.massage = 'Update Successfully';
            }
        ...
        value: function onFormSubmit() {
          var Emp = this.Addemployee.value;
          this.InsertEmployee(Emp);
        }
      }, {
        key: "EmployeeEdit",
        value: function EmployeeEdit(id) {
          var _this2 = this;

          debugger;
          this.emprecordService.GetEmployeeById(id).subscribe(function (emp) {
            _this2.massage = null;
            _this2.dataSaved = false;
            debugger;
            _this2.EmployeeIdUpdate = id;

            _this2.Addemployee.controls['Name'].setValue(emp.name);

            _this2.Addemployee.controls['Department'].setValue(emp.department);

            _this2.Addemployee.controls['City'].setValue(emp.city);

            _this2.Addemployee.controls['Country'].setValue(emp.country);

            _this2.Addemployee.controls['Address'].setValue(emp.address);
          });
          debugger;
        }
      }, {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _addemployee_addemployee_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./addemployee/addemployee.component */
    "./src/app/addemployee/addemployee.component.ts");
    /* harmony import */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _employee_employee_component__WEBPACK_IMPORTED_MODULE_5__["EmployeeComponent"], _addemployee_addemployee_component__WEBPACK_IMPORTED_MODULE_6__["AddemployeeComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_9__["LoginComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["appRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["ReactiveFormsModule"]],
      providers: [],
  ...
  function srcAppEmployeeEmployeeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _emprecord_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../emprecord.service */
    "./src/app/emprecord.service.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function EmployeeComponent(router, emprecordService) {
      ...
      _createClass(EmployeeComponent, [{
        ...
        value: function Loademployee() {
          ...
          debugger;
          this.emprecordService.GetEmployeeRecord().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["first"])()).subscribe(function (emp) {
            _this3.emp = emp;
          });
        }
      }, {
        ...
        value: function Deleteemployee(id) {
          ...
          if (confirm("Are You Sure To Delete this Informations")) {
            this.emprecordService.DeleteEmployee(id).subscribe(function () {
              _this4.dataSaved = true;
              _this4.massage = "Deleted Successfully";
            });
          }
        }
      }, {
  ...
  /***/
  function srcAppEmprecordServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EmprecordService", function () {
    ...
    var EmprecordService =
    /*#__PURE__*/
    function () {
      function EmprecordService(http) {
        _classCallCheck(this, EmprecordService);

        this.http = http;
        this.Url = "http://localhost:5000/Api/Employee/";
      }

      _createClass(EmprecordService, [{
        key: "InsertEmployee",
        value: function InsertEmployee(employee) {
          debugger;
          var httpOptions = {
        ...
        key: "GetEmployeeRecord",
        value: function GetEmployeeRecord() {
        ...
        key: "UpdatEmplouee",
        value: function UpdatEmplouee(employee) {
          debugger;
          var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
              'Content-Type': 'application/json'
    ...
    EmprecordService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    EmprecordService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], EmprecordService);
    /***/
  },
